...
class CountrySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($countries as $coun) {
            $country = new Country();
            $country->id = $coun['id'];
            $country->code = $coun['code'];
            $country->name = $coun['name'];
            $country->phonecode = $coun['phonecode'];
            $country->save();
        }

        // DB::table('countries')->insert($countries); php artisan db:seed --class=CountrySeeder php artisan db:seed --class=StateSeeder
    }
}

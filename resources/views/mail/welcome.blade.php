...
<head>
    ...
    <title>cloud catch assignment Welcome Email</title>
                                                ...
                                                <tr class="">
                                                    <td class="">
                                                        <img alt="robot picture" class="" height="155"
                                                            src="https://www.cloudcatch.co/assets/images/cc_logo.png"
                                                            width="155">
                                                    </td>
                                                </tr>
                                                <tr class="">
                                                    <td class="headline">Welcome to cloud catch!</td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <center class="">
